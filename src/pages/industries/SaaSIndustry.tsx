...
const roles = [
  ...
  { icon: Headphones, title: "Customer Support Specialists" },
  { icon: Wrench, title: "Technical Support Specialists" },
  { icon: Bug, title: "QA Engineers" },
  { icon: Code2, title: "Software Developers" },
  { icon: Database, title: "Data Analysts" },
  { icon: BarChart2, title: "Business Intelligence Analysts" },
  { icon: UserCheck, title: "Onboarding Specialists" },
  { icon: TrendingUp, title: "Sales Development Representatives" },
  { icon: Users, title: "Account Managers" },
  { icon: ClipboardList, title: "Operations Coordinators" },
  { icon: LifeBuoy, title: "Product Support Specialists" },
];

const whyCards = [
  {
    icon: Wifi,
    title: "Remote-First by Nature",
    description:
      "Latin American SaaS professionals already work in Slack, Notion, Jira, HubSpot, and the same tools your team uses every day. Zero learning curve on the workflow side.",
  },
  {
    icon: Clock,
    title: "Same Time Zone",
    description:
      "Your customer success and support teams work your hours, respond to your users in real time, and attend your standups without any async delays.",
  },
  {
    icon: DollarSign,
    title: "Reduce Churn, Not Headcount",
    description:
      "A fully staffed customer success team means faster response times, better onboarding, and stronger retention. At 70% less cost than hiring domestically.",
  },
];
...
const serviceModels = [
  ...
  },
  {
    ...
    description:
      "We source and vet your SaaS professionals and you hire them directly as remote team members integrated into your existing team.",
