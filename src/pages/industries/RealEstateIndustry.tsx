...
const roles = [
  { icon: FileText, title: "Transaction Coordinators" },
  { icon: List, title: "Listing Coordinators" },
  { icon: Bot, title: "Real Estate Virtual Assistants" },
  { icon: Database, title: "CRM and Database Managers" },
  { icon: Phone, title: "Lead Follow Up Specialists" },
  { icon: Building2, title: "Property Management Coordinators" },
  { icon: MessageSquare, title: "Tenant Communication Specialists" },
  { icon: ScrollText, title: "Lease Administrators" },
  { icon: MapPin, title: "MLS Listing Specialists" },
  { icon: Megaphone, title: "Real Estate Marketing Assistants" },
  { icon: CalendarClock, title: "Showing Coordinators" },
...
const whyCards = [
  {
    icon: ShieldCheck,
    title: "US Real Estate Process Trained",
    description:
      "Our real estate professionals understand American transaction timelines, MLS systems, contract documentation, and the deadlines that define every deal.",
  },
  {
    icon: Clock,
    title: "Same Time Zone",
    description:
      "Your transaction and listing coordinators work your hours, respond to your agents in real time, and never miss a deadline because of a time zone gap.",
  },
  {
    icon: DollarSign,
    title: "Free Your Agents to Close",
    description:
      "When your admin and coordination work is handled by a reliable back office team your agents spend more time with clients and less time on paperwork. At 70% less cost than hiring domestically.",
  },
];
...
const serviceModels = [
  ...
  },
  {
    ...
    description:
      "We source and vet your real estate professionals and you hire them directly as remote team members fully integrated into your brokerage systems.",
